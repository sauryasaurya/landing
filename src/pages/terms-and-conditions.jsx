			...
			<section className="container mx-auto mt-40">
				<article className="prose prose-sm max-w-none">
					...
					<p>
						...
						this Agreement) refers to Velorona LLC, 1001 W Euless Boulevard Ste
						411, Euless, TX-76040.
					</p>
					<p>
					...
					<p>
						<strong>Website</strong> refers to Velorona, accessible from{" "}
						<span style={{ color: "#0000ff" }}>
							<u>
								<a href="https://www.velorona.com/">https://www.velorona.com</a>
							</u>
						</span>
					</p>
					<p>
					...
					<p>
						<span style={{ color: "#17365d" }}>
							<span style={{ fontFamily: "Calibri,serif" }}>
								<span style={{ fontSize: "xx-large" }}>Acknowledgment</span>
							</span>
						</span>
					</p>
					<p>
					...
					<p>
						<span style={{ color: "#17365d" }}>
							<span style={{ fontFamily: "Calibri,serif" }}>
								<span style={{ fontSize: "xx-large" }}>Subscriptions</span>
							</span>
						</span>
					</p>
					...
					<p>
						<span style={{ color: "#17365d" }}>
							<span style={{ fontFamily: "Calibri,serif" }}>
								<span style={{ fontSize: "xx-large" }}>User Accounts</span>
							</span>
						</span>
					</p>
					<p>
					...
					<p>
						<span style={{ color: "#17365d" }}>
							<span style={{ fontFamily: "Calibri,serif" }}>
								<span style={{ fontSize: "xx-large" }}>Content</span>
							</span>
						</span>
					</p>
					...
					<p>
						<span style={{ color: "#17365d" }}>
							<span style={{ fontFamily: "Calibri,serif" }}>
								<span style={{ fontSize: "xx-large" }}>Copyright Policy</span>
							</span>
						</span>
					</p>
					...
					<p>
						...
						our copyright agent via email at info@velorona.com and include in
					...
					<p>
						You can contact our copyright agent via email at info@velorona.com.
					...
					<p>
						<span style={{ color: "#17365d" }}>
							<span style={{ fontFamily: "Calibri,serif" }}>
								<span style={{ fontSize: "xx-large" }}>Termination</span>
							</span>
						</span>
					</p>
					<p>
					...
					<p>
						<span style={{ color: "#17365d" }}>
							<span style={{ fontFamily: "Calibri,serif" }}>
								<span style={{ fontSize: "xx-large" }}>Governing Law</span>
							</span>
						</span>
					</p>
					<p>
					...
					<ul>
						<li>
							<p>By email: info@velorona.com</p>
						</li>
					</ul>
				</article>
			</section>
