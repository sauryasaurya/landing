		...
		<ThemeProvider theme={theme}>
			<section className="container mx-auto mt-40">
				<article className="prose prose-sm max-w-none">
					...
					<p>
						<strong>Application</strong> refers to Velorona, the software
					...
					<ul>
						<li>
							<p>
								...
								help support and maintain Our Service, for payment processing,
								to contact You.
							</p>
						</li>
						<li>
					...
					<p>
						Constant Contact is an email marketing sending service provided by
					...
					<p>
						...
						<span style={{ color: "#0000ff" }}>
							<u>
								<a href="https://www.constantcontact.com/forward/privacy-center">
					...
					<p>
						<span style={{ color: "#17365d" }}>
							<span style={{ fontFamily: "Calibri,serif" }}>
								<span style={{ fontSize: "xx-large" }}>GDPR Privacy</span>
							</span>
						</span>
					</p>
